    ...
    if (line.spans.isEmpty) {
      span = TextSpan(
        ...
        style: editorTextStyle.copyWith(
            fontSize: editorFontSize, height: editorLineHeight),
      );
    } else {
  ...
  Color getSpanColor(String label) {
    ...
    switch (label) {
      ...
      case 'math':
        return theme.math;
      case 'math.operator':
        return theme.mathOperator;
      case 'math.punctuation':
        return theme.mathPunctuation;
      case 'math.keyword':
        return theme.mathKeyword;
      case 'math.function':
        return theme.mathFunction;
      case 'math.variable':
        return theme.mathVariable;

      case 'delimiter.L1':
        return theme.delimiterL1;
      case 'delimiter.L2':
        return theme.delimiterL2;
      case 'delimiter.L3':
        return theme.delimiterL3;
      case 'delimiter.L4':
        return theme.delimiterL4;
      case 'delimiter.L5':
        return theme.delimiterL5;
      ...
      default:
        return editorTextStyle.color ?? Colors.black;
    }
  }
}
